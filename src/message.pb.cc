...
inline constexpr GetVerifyRsp::Impl_::Impl_(
    ...
    : email_(&::google::protobuf::internal::fixed_address_empty_string,
             ::_pbi::ConstantInitialized()),
      code_(&::google::protobuf::internal::fixed_address_empty_string,
            ::_pbi::ConstantInitialized()),
      error_{0}, _cached_size_{0} {}
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetVerifyRspDefaultTypeInternal
...
PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 GetVerifyReqDefaultTypeInternal
...
inline PROTOBUF_NDEBUG_INLINE GetVerifyReq::Impl_::Impl_(
    ...
    : email_(arena, from.email_), _cached_size_{0} {}
...
constexpr auto GetVerifyReq::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(
      sizeof(GetVerifyReq), alignof(GetVerifyReq));
}
PROTOBUF_CONSTINIT
...
const ::google::protobuf::internal::ClassDataFull GetVerifyReq::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<GetVerifyReq>(),
        &GetVerifyReq::ByteSizeLong,
        &GetVerifyReq::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(GetVerifyReq, _impl_._cached_size_),
        false,
    },
    &GetVerifyReq::kDescriptorMethods, &descriptor_table_message_2eproto,
    nullptr, // tracker
};
...
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const ::_pbi::TcParseTable<0, 1, 0, 34, 2>
    GetVerifyReq::_table_ = {
        {
            ...
            ::_pbi::TcParser::GetTable<
                ::message::GetVerifyReq>(), // to_prefetch
...
void GetVerifyReq::InternalSwap(GetVerifyReq *PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.email_, &other->_impl_.email_,
                                       arena);
}
...
inline PROTOBUF_NDEBUG_INLINE GetVerifyRsp::Impl_::Impl_(
    ...
    : email_(arena, from.email_), code_(arena, from.code_), _cached_size_{0} {}
...
inline PROTOBUF_NDEBUG_INLINE GetVerifyRsp::Impl_::Impl_(
    ::google::protobuf::internal::InternalVisibility visibility,
    ::google::protobuf::Arena *arena)
    : email_(arena), code_(arena), _cached_size_{0} {}
...
constexpr auto GetVerifyRsp::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(
      sizeof(GetVerifyRsp), alignof(GetVerifyRsp));
}
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1
const ::google::protobuf::internal::ClassDataFull GetVerifyRsp::_class_data_ = {
    ::google::protobuf::internal::ClassData{
        ...
        ::google::protobuf::Message::GetClearImpl<GetVerifyRsp>(),
        &GetVerifyRsp::ByteSizeLong,
        &GetVerifyRsp::_InternalSerialize,
#endif // PROTOBUF_CUSTOM_VTABLE
        PROTOBUF_FIELD_OFFSET(GetVerifyRsp, _impl_._cached_size_),
        false,
    },
    &GetVerifyRsp::kDescriptorMethods, &descriptor_table_message_2eproto,
    nullptr, // tracker
};
const ::google::protobuf::internal::ClassData *
...
#ifdef PROTOBUF_PREFETCH_PARSE_TABLE
            ::_pbi::TcParser::GetTable<
                ::message::GetVerifyRsp>(), // to_prefetch
#endif                                      // PROTOBUF_PREFETCH_PARSE_TABLE
        },
        {{
            ...
            {::_pbi::TcParser::SingularVarintNoZag1<
                 ::uint32_t, offsetof(GetVerifyRsp, _impl_.error_), 63>(),
...
::uint8_t *GetVerifyRsp::_InternalSerialize(
  ...
  if (this_._internal_error() != 0) {
    target = ::google::protobuf::internal::WireFormatLite::
        WriteInt32ToArrayWithField<1>(stream, this_._internal_error(), target);
  }
...
::size_t GetVerifyRsp::ByteSizeLong() const {
  ...
  ::_pbi::Prefetch5LinesFrom7Lines(&this_);
  {
    ...
    if (this_._internal_error() != 0) {
      total_size +=
          ::_pbi::WireFormatLite::Int32SizePlusOne(this_._internal_error());
    }
  }
  return this_.MaybeComputeUnknownFieldsSize(total_size,
                                             &this_._impl_._cached_size_);
...
void GetVerifyRsp::InternalSwap(GetVerifyRsp *PROTOBUF_RESTRICT other) {
  ...
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.email_, &other->_impl_.email_,
                                       arena);
  ::_pbi::ArenaStringPtr::InternalSwap(&_impl_.code_, &other->_impl_.code_,
                                       arena);
